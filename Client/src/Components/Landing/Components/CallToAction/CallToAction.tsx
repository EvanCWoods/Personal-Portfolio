          ...
          <Box
            ...
            <Box
              ...
              <Box className="landing-small">
                ...
                <button style={{ padding: "2% 4%", border: "none", background: "var(--yellow-background)", borderRadius: "10px", marginTop: "100px", marginLeft: "5%", fontSize: "1rem" }} onClick={handleOpenModal}>INQUIRE</button>
              </Box>
            </Box>
          </Box>
        </Box>
